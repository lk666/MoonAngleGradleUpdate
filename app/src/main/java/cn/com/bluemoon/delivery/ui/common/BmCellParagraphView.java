            ...
            for (int i = 0; i < n; i++) {
                ...
                switch (attr) {
                    case R.styleable.BmCellParagraphView_cell_paragraph_txt_title:
                        ...
                        break;
                    case R.styleable.BmCellParagraphView_cell_paragraph_title_color:
                        titleColor = attribute.getColor(attr, Color.parseColor("#666666"));
                        break;
                    case R.styleable.BmCellParagraphView_cell_paragraph_title_size:
                    ...
                    case R.styleable.BmCellParagraphView_cell_paragraph_txt_content:
                        ...
                        break;
                    case R.styleable.BmCellParagraphView_cell_paragraph_content_color:
                        contentColor = attribute.getColor(attr, Color.parseColor("#333333"));
                        break;
                    case R.styleable.BmCellParagraphView_cell_paragraph_content_size:
                        contentSize = attribute.getDimensionPixelSize(attr,0);
                        break;
                    case R.styleable.BmCellParagraphView_cell_paragraph_line_color:
                        lineBg = attribute.getColor(attr,Color.parseColor("#E5E5E5"));
                        break;
                    case R.styleable.BmCellParagraphView_cell_paragraph_line_height:
                        lineHeight = attribute.getDimensionPixelSize(attr,-1);
                        break;
                    case R.styleable.BmCellParagraphView_cell_paragraph_line_paddingleft:
                        linePaddingLeft = attribute.getDimensionPixelSize(attr,0);
                        break;
                    case R.styleable.BmCellParagraphView_cell_paragraph_line_paddingright:
