...
public class OrdersTabActivity extends FragmentActivity {
	...
	private View getTabItemView(int resId, String content, int index) {
		...
		case 1:
			...
			break;
		case 2:
			amountTv3 = (TextView)view.findViewById(R.id.txt_count);
			break;
		case 3:
			amountTv4 = (TextView)view.findViewById(R.id.txt_count);
			break;
	...
	public void setAmountShow() {
		DeliveryApi.getOrderCount(ClientStateManager.getLoginToken(OrdersTabActivity.this), getOrderCountHandler);
	}
