...
public class SimpleWheelView extends View {
    ...
    private void onEndSelectListener(final int index) {
        if (onSelectListener != null) {
            post(new Runnable() {
                ...
                public void run() {
                    if (!isLoop) {
                        onSelectListener.onEndSelected(index, getItemText(index, true));
                    } else {
                        int oriIndex = getOriIndex(index);
                        onSelectListener.onEndSelected(oriIndex, getListItemText(oriIndex));
                    }
                }
            });
        }
     ...
     * @param selectedIndex 选中项
     */
    public void resetData(ArrayList<String> data, int selectedIndex) {
        initData(data, selectedIndex);
        invalidate();
    }
    ...
    public String getSelectedText() {
        return getItemText(selectedIndex, true);
    }
