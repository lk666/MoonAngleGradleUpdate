...
public class DeliveryDialog extends DialogFragment {
	...
	public static DeliveryDialog newInstance(int id) {
		DeliveryDialog alertDialogFragment = new DeliveryDialog();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.dialog_delivery, container, false);
