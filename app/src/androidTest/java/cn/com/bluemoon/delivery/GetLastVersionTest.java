 ...
 */
public class GetLastVersionTest extends InstrumentationTestCase {

    private String Tag;

    public GetLastVersionTest() {
        super();
        AppContext.getInstance();
        Tag = "GetLastVersionTest";
    }

    public void testGetLastVersionSuccess() throws Throwable {
        ...
        runTestOnUiThread(new Runnable() { // THIS IS THE KEY TO SUCCESS
            @Override
            public void run() {
                AsyncHttpResponseHandler checkVersionHandler = new TextHttpResponseHandler(HTTP.UTF_8) {
        ...
        try {
            ResultVersionInfo tokenResult = JSON.parseObject(strBuilder.toString(),
