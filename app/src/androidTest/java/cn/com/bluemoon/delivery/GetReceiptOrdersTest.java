...
/*已收货-汇总接口 */
/* 返回： ResultOrderVo */
public class GetReceiptOrdersTest extends InstrumentationTestCase {

    private String Tag;

    public GetReceiptOrdersTest() {
        super();
        AppContext.getInstance();
        Tag = "GetReceiptOrdersTest";
    }

    public void testGetReceiptOrdersSuccess() throws Throwable {
