 ...
 */
public class IsPunchCardTest extends InstrumentationTestCase {

    private String Tag;

    public IsPunchCardTest() {
        super();
        AppContext.getInstance();
        Tag = "IsPunchCardTest";
    }

    public void testIsPunchCardSuccess() throws Throwable {
        ...
        runTestOnUiThread(new Runnable() { // THIS IS THE KEY TO SUCCESS
            ...
            public void run() {
                ...
                DeliveryApi.isPunchCard(token, isPunchCardHandler);
        ...
        try {
            ResultIsPunchCard tokenResult = JSON.parseObject(strBuilder.toString(),
